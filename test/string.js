...
describe('string', function () {
    ...
    describe('#validate', function () {
        ...
        // Skip test: Options not supported in 'isemail' shim
        it.skip('validates email with tldWhitelist as array', function (done) {
        ...
        // Skip test: Options not supported in 'isemail' shim
        it.skip('validates email with tldWhitelist as object', function (done) {
        ...
        // Skip test: Options not supported in 'isemail' shim
        it.skip('validates email with minDomainAtoms', function (done) {
        ...
        // Skip test: Options not supported in 'isemail' shim
        it.skip('validates email with errorLevel as boolean', function (done) {
        ...
        // Skip test: Options not supported in 'isemail' shim
        it.skip('validates email with errorLevel as integer', function (done) {
